...
class UpdateActionTest extends AbstractTestCase
{
    ...
    public function testStandardRequest(): void
    {
        ...
        self::assertEquals('This value should not be blank.', $formGroupRequired->filter('ul li')->text(null, true));
        ...
        self::assertEquals($exampleEntity->getId(), $dds->eq(0)->text(null, true));
        self::assertEquals('requiredReadonly00001', $dds->eq(1)->text(null, true));
        self::assertEquals('ChangedValue', $dds->eq(2)->text(null, true));
    }
}
