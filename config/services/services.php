...
use Dontdrinkandroot\CrudAdminBundle\Event\Listener\FilterAndSortableListener;
...
return function (ContainerConfigurator $configurator): void {
    ...
    $services->set(CrudAdminExtension::class, CrudAdminExtension::class)
        ->args([
            ...
            service(TitleResolverInterface::class),
    ...
    $services->set(DefaultRedirectAfterWriteListener::class)
        ->args([
            service(UrlResolverInterface::class),
    ...
    $services
        ->set(FilterAndSortableListener::class)
        ->autowire()
