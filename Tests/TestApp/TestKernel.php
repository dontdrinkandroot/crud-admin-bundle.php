...
class TestKernel extends Kernel
{
    ...
    {
        $contents = require $this->getProjectDir() . '/Tests/TestApp/config/bundles.php';
    ...
    {
        $container->addResource(new FileResource($this->getProjectDir() . '/Tests/TestApp/config/bundles.php'));
